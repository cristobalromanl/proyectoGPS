...
const navbarUsr = () => {
  ...
  return (
    <Box height="100vh" backgroundImage={"url('./Estadio.jpg')"} backgroundSize="160%" backgroundPosition="center"
    sx={{"@media screen and (max-width: 861px)": {backgroundImage: `url('./fondoMenu.jpg')`,
     backgroundSize:"100%",height:"auto", backgroundPosition:"cover" },}}>
        ...
        <Box position="relative" mt={10} py={5} display="flex" justifyContent="center" alignItems="center" width="100vw">
                    ...
                    <Wrap spacing='10px' justify='center'>
                        <Wrap spacing='10px' direction="column">
                            <WrapItem >
                                ...
                                w={410} h={140} _hover={{border:"1px solid #05f3ff", cursor:"pointer"}}>
                      ...
                      <WrapItem >
                        ...
                        w={355} h={290} _hover={{border:"1px solid #05f3ff", cursor:"pointer"}}
                        sx={{"@media screen and (max-width: 861px)": {width: "410px!important", height: "300px"},}}>
                      ...
                      <Wrap spacing='10px' justify='center' >
                        <WrapItem >
                          ...
                          w={200} h={135} _hover={{border:"1px solid #05f3ff", cursor:"pointer"}}
                          sx={{"@media screen and (max-width: 455px)": {width: "410px!important"},}}>
                          </Center>
                        </WrapItem>
                        
                        <WrapItem >
                            <Center bg={`url("./clubes2.jpg")`} backgroundSize="cover"  borderRadius={3}
                            w={200} h={135} _hover={{border:"1px solid #05f3ff", cursor:"pointer"}}
                            sx={{"@media screen and (max-width: 455px)": {width: "410px!important", height: "130px"},
                            backgroundPosition: "cover"}}>
                              <Text fontWeight={500} fontSize="2em" p={4} color="myColor.Snow">Clubes</Text>
                            </Center>
                        </WrapItem>
                        <WrapItem>
                            <Center bg={`url("./Eventos.png")`} backgroundSize="cover"  borderRadius={3}
                            w={355} h={135} _hover={{border:"1px solid #05f3ff", cursor:"pointer"}}
                            sx={{"@media screen and (max-width: 861px)": {width: "410px!important", height: "140px"},}}>
                            </Center>
                        </WrapItem>
                      </Wrap>
                    </Wrap>
