  ...
  return (
    <Container  margin={'0'} p={'0'} maxW={'full'} maxH={'full'}>
      <HStack as="nav" p="10px" bg="#5D3C81">
        <Heading color={'white'}><Image src='/img/Sportify.png' w={'110px'} h={'100'}/></Heading>
        <Spacer/>
      ...
      <VStack bg={"#c08ee1"} width={'full'} height={' container.lg'}>
        ...
        <HStack spacing={'30px'}> 
        <Card bg={'#c08ee1'} w={'250px'} h={'252px'}transition={['0.3s', 'ease']}  boxShadow={'dark-lg'} cursor={'pointer'} onClick={()=>{location.href='/reserva/canchas'}}>
            <CardBody>
          ...
          <Card bg={'#c08ee1'} w={'250px'} h={'252px'} transition={['0.3s', 'ease']}  boxShadow={'dark-lg'} cursor={'pointer'}>
            <CardBody>
              <Flex direction={'column'} alignContent={'center'} justify={'center'} onClick={()=>{location.href='/reserva/canchas'}}>
